    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <nav class="tab-navigation">
                <ul class="nav nav-tabs mb-3" role="tablist" id="route-tabs">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" href="#tab-details" id="tab-link-details" aria-selected="true"
                            role="tab" aria-controls="tab-details" data-toggle="tab">
                            <i class="fa fa-info-circle me-1"></i> Details
                        </a>
                    </li>

                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="#tab-gallery" id="tab-link-gallery" aria-selected="false" role="tab"
                            aria-controls="tab-gallery" data-toggle="tab">
                            <i class="fa fa-images me-1"></i> Galerie
                        </a>
                    </li>

                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="#tab-videos" id="tab-link-videos" aria-selected="false" role="tab"
                            aria-controls="tab-videos" data-toggle="tab">
                            <i class="fa fa-video me-1"></i> Videos
                        </a>
                    </li>

                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="#tab-map" id="tab-link-map" aria-selected="false" role="tab"
                            aria-controls="tab-map" data-toggle="tab">
            ...
            <div class="tab-content">
                ...
                <!-- Galerie -->
                <div class="tab-pane fade" id="tab-gallery" role="tabpanel" aria-labelledby="tab-link-gallery">
                    ...
                    <div id="gallery-carousel-{$route.id}" class="row" data-bs-ride="false">
                        ...
                        <div class="col-md-3 mb-2">
                            <a href="{$img.image_url}" data-lightbox="gallery-{$route.id}"
                                data-title="{$img.alt|default:''}">
                ...
                <div class="tab-pane fade" id="tab-videos" role="tabpanel" aria-labelledby="tab-link-videos">
                    ...
                    <div class="mb-2">
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/{$video.value}"
                ...
                <!-- Map -->
                <div class="tab-pane fade" id="tab-map" role="tabpanel" aria-labelledby="tab-link-map">
